...
from ..gwm_arch import GWMMetaModel, GWMMetaForCausalLM
...
class GWMModel(GWMMMetaModel, LlamaModel):
    config_class = LlagaConfig

    def __init__(self, config: LlamaConfig):
        super(GWMLlamaModel, self).__init__(config)


class GWMLlamaForCausalLM(LlamaForCausalLM, LlagaMetaForCausalLM):
    config_class = LlagaConfig
...
AutoConfig.register("gwm", LlagaConfig)
